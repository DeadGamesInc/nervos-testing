...
module.exports = {
  ...
  networks: {
    develop: {
      provider: () => {
        const wallet = new HDWalletProvider(mnemonic, 'http://127.0.0.1:8545', 0, 3, false)
        return wallet
      },
      port: 8545,
      network_id: 97,
    ...
    ckb_testnet: {
        provider: () => new HDWalletProvider(mnemonic, `https://godwoken-testnet-web3-v1-rpc.ckbapp.dev/`),
